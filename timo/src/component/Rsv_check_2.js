    ...
    return (
        <Box  >
            ...
            <Grid container spacing={2} >
                <Grid item xs={7} style={{ marginLeft:"25px", marginTop: "7px" }} >
                    <span style={{ fontWeight: 'bold', color: 'black', fontSize: '22px' }}>롯데캐슬킹덤아파트</span>
                </Grid>
            </Grid>
            <br />
            ...
            <Grid container spacing={2} style={{ marginLeft: "20px" }}>
                ...
                <Grid item xs={10} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#525252', fontSize: '15px' }}>2023.06.30 (금) 오후 12:00</span>
                </Grid>
                <Grid item xs={2} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#BFBFBF', fontSize: '15px' }}>이름</span>
                </Grid>
                <Grid item xs={10} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#525252', fontSize: '15px' }}>이예지</span>
                </Grid>
                <Grid item xs={2} style={{ textAlign: 'left' }}>
                ...
                <Grid item xs={10} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#525252', fontSize: '15px' }}>4세</span>
                </Grid>
                <Grid item xs={2} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#BFBFBF', fontSize: '15px' }}>연락처</span>
                </Grid>
                <Grid item xs={10} style={{ textAlign: 'left' }}>
                    <span style={{ color: '#525252', fontSize: '15px' }}>010-1234-5678</span>
                </Grid>
                <br />
                <br />
                <br />
            ...
            >
                ...
                <Button onClick={handleClose} style={{backgroundColor:'#CBE23A' , color:'white', width:'294px', marginLeft:'-32px', marginTop:'30px', borderBottomLeftRadius:'30px', borderBottomRightRadius:'30px', height:'50px'}}>
                        확인
                </Button>
