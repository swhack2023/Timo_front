...
const Baby_sitter4 = () => {
  ...
  return (
    <Box>
      ...
      <Button onClick={Rc4} variant="contained" size="large" disableElevation style={{ backgroundColor: '#C6D93B', color: 'black', marginBottom: '5px', marginRight: '20px', width: '35%', height: '45px' }}>돌봐줄게요!</Button>
